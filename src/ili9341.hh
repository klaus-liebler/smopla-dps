...
class TFT_ILI9341 : public SPILCD16bit{

 public:
	TFT_ILI9341(SPI_TypeDef* spi, const uint32_t dmaChannel, const int16_t physicalWidth, const int16_t physicalHeigth, const DisplayRotation rotation, const Pin cspin, const Pin dcpin, const Pin backlightPin, const Pin rstpin);
		virtual ~TFT_ILI9341(){}
